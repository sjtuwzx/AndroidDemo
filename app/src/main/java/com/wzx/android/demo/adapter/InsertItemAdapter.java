package com.wzx.android.demo.adapter;
...
public class InsertItemAdapter extends BaseAdapter {
    ...
    private static final int DEFAULT_TYPE_COUNT_INSERT_ITEM = 10;
    ...
    public int getItemViewType(int position) {
        if (isInsertItem(position)) {
            return getInsertedItemViewType(position);
        } else {
            return mInsertedItemTypeCount + mOriginAdapter.getItemViewType(getOriginPosition(position));
        }
    }
