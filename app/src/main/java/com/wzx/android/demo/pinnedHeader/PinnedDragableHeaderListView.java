...
public class PinnedDragableHeaderListView extends PinnedDoubleHeaderListView {
    ...
    protected void privateOnScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        ...
        super.privateOnScroll(view, firstVisibleItem, visibleItemCount, totalItemCount);
    }
    ...
    private void refreshPinnedHeaderLocation() {
        ...
        super.privateOnScroll(this, getFirstVisiblePosition(), getChildCount(), totalItemCount);
        invalidate();
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (mScrolling) {
            ss.pinnedHeaderMarginTop = mScroller.getFinalY();
        }
        return ss;
    }
